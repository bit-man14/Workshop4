class DomElements {
    ...
    addShowAddOperationTime() {
        document.querySelector("div.todo-app").addEventListener("click", e => {
            if (e.target.classList.contains("add-time") && !e.target.classList.contains("btn-success")) {
                e.preventDefault();
            ...
            } else if (e.target.classList.contains("add-time") && e.target.classList.contains("btn-success")) {
                e.preventDefault();
                let element = e.target;
